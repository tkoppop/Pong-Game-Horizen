...
Pong = {
    ...
    EventsHandler: {
      initialize: function(pong) {
        this.game = pong.game;
        this.handlers = Object.extend(
          pong.Defaults.eventHandlers,
          pong.cfg.eventHandlers
        );
      },
      notify: function(event, message, data) {
    ...
    initialize: function(runner, cfg) {
      Game.loadImages(
        ...
        function(images) {
          ...
          this.eventsHandler = Object.construct(Pong.EventsHandler, this);
    ...
    start: function(numPlayers) {
      ...
      if (!this.playing) {
        ...
        this.rightPaddle.setAuto(numPlayers < 2, 15);
        this.ball.reset();
    ...
    finish: function(winnerPlayerNo) {
      this.eventsHandler.notify("end", "Game finished", {
        winner: winnerPlayerNo
      });
      this.menu.declareWinner(winnerPlayerNo);
      this.stop();
    },
    update: function(dt) {
